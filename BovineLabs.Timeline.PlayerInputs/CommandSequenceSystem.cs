...
namespace BovineLabs.Timeline.PlayerInputs
{
    ...
    public partial struct CommandSequenceSystem : ISystem
    {
        ...
        private partial struct GatherJob : IJobEntity
        {
            ...
            private static bool EvaluateLiveState(in CommandStep step, in InputState state)
            {
            ...
            private static bool EvaluateContains(in CommandStep step, in DynamicBuffer<InputHistory> history,
            ...
            private static bool EvaluateFirstConsume(in CommandStep step, in DynamicBuffer<InputHistory> history,
            ...
            private static bool EvaluateLastConsume(in CommandStep step, in DynamicBuffer<InputHistory> history,
                ref BitArray256 consumeMask, ref uint lastMatchTick)
            {
            ...
            private static bool EvaluateOrdered(in CommandStep step, in DynamicBuffer<InputHistory> history,
            ...
            private static bool EvaluateOrderedFirstConsume(in CommandStep step,
                in DynamicBuffer<InputHistory> history, ref BitArray256 consumeMask, ref int searchIndex,
                ref uint lastMatchTick)
            {
                for (var i = searchIndex; i < history.Length; i++)
            ...
            private static bool EvaluateOrderedLastConsume(in CommandStep step,
                in DynamicBuffer<InputHistory> history, ref BitArray256 consumeMask, ref int searchIndex,
                ref uint lastMatchTick)
            {
            ...
            private static bool EvaluateNotContains(in CommandStep step, in DynamicBuffer<InputHistory> history,
            ...
            private static bool EvaluateNotFirst(in CommandStep step, in DynamicBuffer<InputHistory> history,
                ref BitArray256 consumeMask)
            {
                for (var i = 0; i < history.Length; i++)
                {
            ...
            private static bool EvaluateNotLast(in CommandStep step, in DynamicBuffer<InputHistory> history,
                ref BitArray256 consumeMask)
            {
                for (var i = history.Length - 1; i >= 0; i--)
                {
