...
namespace BovineLabs.Timeline.PlayerInputs.Tests
{
    public class EventAccumulationTests
    {
        ...
        public void TryMerge_SameKey_SumsAmount_Merged()
        {
            ...
            values.Add(new EventAmount(new ConditionKey(new BovineLabs.Core.BLId(7)), 3));

            var result = EventAccumulation.TryMerge(ref values, new EventAmount(new ConditionKey(new BovineLabs.Core.BLId(7)), 4));
        ...
        public void TryMerge_NewKeyWithRoom_Appended()
        {
            ...
            var result = EventAccumulation.TryMerge(ref values, new EventAmount(new ConditionKey(new BovineLabs.Core.BLId(8)), 5));
        ...
        public void TryMerge_AtCapacity_NewKey_Overflow()
        {
            ...
            while (values.Length < values.Capacity)
                values.Add(new EventAmount(new ConditionKey(new BovineLabs.Core.BLId(++key)), 1));

            var result = EventAccumulation.TryMerge(ref values, new EventAmount(new ConditionKey(new BovineLabs.Core.BLId(key + 1)), 9));
        ...
        public void TryMerge_AtCapacity_ExistingKey_StillMerges()
        {
            ...
            var result = EventAccumulation.TryMerge(ref values, new EventAmount(new ConditionKey(new BovineLabs.Core.BLId(1)), 10));
